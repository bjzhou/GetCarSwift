...
/*!
 聊天室的成员信息RCChatRoomMemberInfo列表
 
 @discussion 如果成员类型为RC_ChatRoom_Member_NONE，则为nil；
 如果成员类型为RC_ChatRoom_Member_PART_ASC，则为最早加入的成员列表，按成员加入时间升序排列；
 如果成员类型为RC_ChatRoom_Member_PART_DESC，则为最晚加入的成员列表，按成员加入时间升序排列。
 */
