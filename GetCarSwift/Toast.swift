...
let HRToastPositionBottom  =   "bottom"
let HRToastPositionTop      =   "top"
let HRToastPositionCenter   =   "center"

let HRToastPositionDefault = HRToastPositionCenter
    ...
    */
    ...
    func centerPointForPosition(position: AnyObject, toast: UIView) -> CGPoint {
        if position is String {
            ...
            } else if position.lowercaseString == HRToastPositionBottom {
    ...
    func viewForMessage(msg: String?, title: String?, image: UIImage?) -> UIView? {
        ...
        if title != nil {
            ...
            let expectedWidth = min(maxSizeTitle.width, title!.stringWidth(HRToastFontSize) - imageWidth)
            let expectedHeight = title!.stringHeight(HRToastFontSize, width: maxSizeTitle.width)
        ...
        if msg != nil {
            ...
            let expectedWidth = min(maxSizeMessage.width, msg!.stringWidth(HRToastFontSize) - imageWidth)
            let expectedHeight = msg!.stringHeight(HRToastFontSize, width: maxSizeMessage.width)
