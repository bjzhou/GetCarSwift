...
class WebViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        backBarButton = UIBarButtonItem(image: UIImage(named: "back"), style: .Plain, target: self, action: Selector("didBack"))
        forwardBarButton = UIBarButtonItem(image: UIImage(named: "arrow"), style: .Plain, target: self, action: Selector("didForward"))
