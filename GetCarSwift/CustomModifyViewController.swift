...
class CustomModifyViewController: UIViewController {
    ...
    func buttonAnimate(button: UIButton!) {
        let animateImages = [UIImage(named: "ani_press_1")!, UIImage(named: "ani_press_2")!, UIImage(named: "ani_press_3")!]
    ...
    @IBAction func onLunguAction(sender: UIButton) {
        ...
        let otherButton = self.view.viewWithTag(sender.tag == 1 ? 2 : 1) as? UIButton
